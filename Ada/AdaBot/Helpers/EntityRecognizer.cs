...
namespace AdaBot.BotFrameworkHelpers
{
    public class EntityRecognizer
    {
        ...
        public void ParseDateTime(List<EntityRecommendation> entities, out DateTime? parsedDate)
        {
            parsedDate = ResolveDateTime(entities);
        }

        //public void ParseDateTime(string utterance, out DateTime? parsedDate)
        //{
        ...
        private static DateTime? ResolveDateTime(List<EntityRecommendation> entities)
        {
            DateTime? date = null;
            DateTime? time = null;
        ...
        private DateTime? RecognizeTime(string utterance)
        {
            try
            {
